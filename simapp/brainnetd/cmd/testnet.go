...
Example:
	...
	cmd.Flags().String(flagNodeDaemonHome, "brainnetd", "Home directory of the node's daemon configuration")
...
func initTestnetFiles(
	...
	// Update viper root since root dir become rootdir/node/brainnetd
